...
// Skel.
	skel.init({
		reset: 'full',
		breakpoints: {
			'global': { range: '*', href: 'assets/style.css', lockViewport: true, viewport: 'minimal-ui' },
			'wide': { range: '-1680', href: 'assets/style-wide.css' },
			'normal': { range: '-1280', href: 'assets/style-normal.css' },
			'mobile': { range: '-640', href: 'assets/style-mobile.css' },
			'mobilep': { range: '-360', href: 'assets/style-mobilep.css' }
		}
	});
